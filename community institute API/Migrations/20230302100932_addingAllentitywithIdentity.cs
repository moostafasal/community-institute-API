        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Professors_proffid",
                        column: x => x.proffid,
                        principalTable: "Professors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Assignments_TAs_TAid",
                        column: x => x.TAid,
                        principalTable: "TAs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassMaterials_clases_clasesId",
                        column: x => x.clasesId,
                        principalTable: "clases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassMaterials_Professors_proffID",
                        column: x => x.proffID,
                        principalTable: "Professors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassMaterials_TAs_TAId",
                        column: x => x.TAId,
                        principalTable: "TAs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_clases_classid",
                        column: x => x.classid,
                        principalTable: "clases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TAsclases", x => new { x.ClassesId, x.TAsId });
                    table.ForeignKey(
                        name: "FK_TAsclases_clases_ClassesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Solutions_Enrollments_EnrollmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_proffid",
                table: "Assignments",
                column: "proffid");

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_TAid",
                table: "Assignments",
                column: "TAid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassMaterials_proffID",
                table: "ClassMaterials",
                column: "proffID");

            migrationBuilder.CreateIndex(
                name: "IX_ClassMaterials_TAId",
                table: "ClassMaterials",
                column: "TAId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solutions_EnrollmentId",
                table: "Solutions",
                column: "EnrollmentId");
